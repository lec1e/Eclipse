...
namespace Froststrap
{
    static class Paths
    {
        ...
        /// <summary>
        /// Downloads for Eclipse self-updates live under LocalAppData\Eclipse\Updates
        /// (not the process temp folder).
        /// </summary>
        public static string TempUpdates => Path.Combine(LocalAppData, App.ProjectName, "Updates");
        ...
        public static void Initialize(string baseDirectory)
        {
            ...
            FastFlagProfiles = Path.Combine(DataRoot, "FastFlagProfiles");
            ...
            Directory.CreateDirectory(FastFlagProfiles);
