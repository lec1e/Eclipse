...
namespace Froststrap
{
    public class FastFlagManager : JsonManager<Dictionary<string, object>>
    {
        ...
        // Which Versions Manager profile's flag set this manager reads/writes. Empty => active profile.
        ...
        public override string FileLocation
        {
            get
            {
                ...
                if (string.IsNullOrEmpty(id) || string.IsNullOrEmpty(Paths.FastFlagProfiles))
