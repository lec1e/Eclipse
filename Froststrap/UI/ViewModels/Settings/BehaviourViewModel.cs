namespace Froststrap.UI.ViewModels.Settings
{
    public class BehaviourViewModel : NotifyPropertyChangedViewModel
    {
        ...
        public System.Collections.ObjectModel.ObservableCollection<VersionProfile> VersionProfiles => App.Settings.Prop.VersionProfiles;

        public VersionProfile? SelectedVersionProfile
        {
            get => App.Settings.Prop.VersionProfiles.FirstOrDefault(p => p.Id == App.Settings.Prop.ActiveVersionProfileId);
            set
            {
                if (value is null) return;
                App.Settings.Prop.ActiveVersionProfileId = value.Id;
                if (string.IsNullOrEmpty(value.VersionGuid))
                {
        ...
        public bool ShowVersionPickerOnLaunch
        {
            ...
            set => App.Settings.Prop.ShowVersionPickerOnLaunch = value;
        }

        public bool ForceLiveChannel
        {
            get => App.Settings.Prop.ForceLiveChannel;
            set => App.Settings.Prop.ForceLiveChannel = value;
        }
